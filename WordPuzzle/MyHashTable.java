...
public class MyHashTable <AnyType> {
	 ...
	 * @param x the item to search for.
	 * @return the matching item.
	 * b[0] is for isActive, b[1] is for isWord
	 */
	public boolean[] containsIsWord( AnyType x )
	{
	...
	private static class HashEntry<AnyType>
	{
		...
		public boolean isWord;    // flase if it is not a word in dict
